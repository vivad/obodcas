		...
		<div id="content">
			...
			<?php
				...
				if($totalCount != 0){
					...
					<input type="hidden" id="keyArea" value="<?php echo $keyArea;?>"/>
					<input type="hidden" id="keyVendor" value="<?php echo $keyVendor;?>"/>
					<input type="hidden" id="keyKeyword" value="<?php echo $keyKeyword;?>"/>
